...
// set pin numbers:
const int UpPin =  5;      // The pin used to control the forward move
const int DwnPin =  4;      // The pin used to control the backward move
const int RghtPin =  3;      // The pin used to control the right move
const int LftPin =  2;      // The pin used to control the left move
